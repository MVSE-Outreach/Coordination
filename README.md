...
We've produced a [guide](Creating-A-Workshop) including all the steps, the things you need to know and guidelines that need to be followed (along with a load of tips). Take a look at the [Creating A Workshop](Creating-A-Workshop) page.
